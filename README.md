...
lantoo/0.0.8 linux-x64 node-v14.17.4
$ lantoo --help [COMMAND]
USAGE
  $ lantoo COMMAND
...
...
_See code: [src/commands/base.ts](https://github.com/ajsaraujo/lantoo/blob/v0.0.8/src/commands/base.ts)_
...
_See code: [src/commands/config.ts](https://github.com/ajsaraujo/lantoo/blob/v0.0.8/src/commands/config.ts)_
...
_See code: [src/commands/find.ts](https://github.com/ajsaraujo/lantoo/blob/v0.0.8/src/commands/find.ts)_
...
_See code: [src/commands/translate.ts](https://github.com/ajsaraujo/lantoo/blob/v0.0.8/src/commands/translate.ts)_
<!-- commandsstop -->
